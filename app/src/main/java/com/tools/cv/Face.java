...
public class Face {
  ...
  public Face(int width, int height, int imgWidth, int imgHeight, int x, int y, float left_x,
      float left_y, float right_x, float right_y, float nose_x, float nose_y,
      float mouseLeft_x, float mouseLeft_y, float mouseRight_x, float mouseRight_y) {
    this.width = width;
    this.height = height;
