...
attribute_deprecated SwsVector
*
...
attribute_deprecated void sws_shiftVec(SwsVector *a, int
shift);
...
attribute_deprecated void sws_printVec2(SwsVector *a, AVClass *log_ctx, int
log_level);
