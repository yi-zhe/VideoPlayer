...
Java_com_tools_live_ImageUtils_rotation(JNIEnv *env, jclass clazz, jbyteArray data_, jint width,
                                        jint height, jint degrees) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_tools_live_ImageUtils_scale(JNIEnv *env, jclass clazz, jbyteArray src_, jbyteArray dst_,
                                     jint srcWidth,
